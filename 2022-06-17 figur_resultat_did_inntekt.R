...
graf_utprint  %>% ggsave( filename = "plot/figur7.png", device = "png", width = 10, height =10 ) 
graf_utprint  %>% ggsave( filename = "plot/SVG/figur7.svg", device = "svg", width = 10, height =10 ) 
