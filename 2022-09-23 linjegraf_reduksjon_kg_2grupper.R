...
# Print
graf_13 %>% ggsave( filename = "plot/graf_linje_reduksjon_kg", device = "png", width = 8, height =4 )
graf_13 %>% ggsave( filename = "plot/SVG/graf_linje_reduksjon_kg.svg", device = "png", width = 8, height =4 )
graf_13 %>% ggsave( filename = "plot/SVG/figur2.svg", device = "svg", width = 8, height =4 )
